...
import com.example.loginregisterfirebase.Volunteers.VolunteerReport;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Validation
                if (emailValidator.Validate(userid,Login.this) && passwordValidator.Validate(password,Login.this)) {
